...
The tag is supported by many [podcast apps](/docs/podcast-namespace/tags/funding#fs-podcast-apps) and directories, including the popular Pocket Casts app, as well as Podcast Addict and AntennaPod, two of the largest Android apps.

It's also supported by most large [podcast hosts](/docs/podcast-namespace/tags/funding#fs-tools), including Buzzsprout, RSS.com, Powerpress by Blubrry, and Transistor.
