...
The tag is [supported by many podcast apps and directories](/docs/podcast-namespace/tags/funding#fs-podcast-apps), including the popular Pocket Casts app, as well as Podcast Addict and AntennaPod, two of the largest Android apps.
